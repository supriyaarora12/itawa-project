    ...
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden" id="features">
      ...
      <div className="container max-w-7xl mx-auto  relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p
            className="text-base lg:text-lg max-w-2xl mx-auto leading-relaxed text-[var(--gray)] font-[var(--font-family-sans-serif)]"
          >
        ...
        <div className="relative overflow-hidden">
          <div
            className="flex gap-4 transition-transform duration-700 ease-in-out items-stretch"
            style={{
              transform: features.length > 3 
                ? `translateX(-${(currentIndex * (100 / 3)).toFixed(2)}%)` 
                : 'translateX(0)',
            }}
          >
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        {iconMap[feature.icon] || <Warehouse className="w-6 h-6 text-[#173C65]" />}
                        <h3
                          className="text-xl font-bold text-[#173C65] font-['Libre_Baskerville',Georgia,serif] font-normal text-[1.25rem]"
                        >
                          {feature.label}
                        </h3>
                      </div>
                      ...
                      <div className="mb-2">
                        <span
                          className="text-2xl font-bold text-[#173C65] font-[var(--font-family-sans-serif)]"
                        >
                          {feature.value}
                        </span>
                      </div>
                      ...
                      {feature.description && (
                        <p
                          className="text-sm text-[var(--gray)] font-[var(--font-family-sans-serif)]"
                        >
                          {feature.description}
                        </p>
                      )}
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            {Array.from({ length: maxPosition + 1 }).map((_, index) => (
              <button
                ...
                className={`transition-all duration-300 rounded-[2px] border-none cursor-pointer ${
                  index === currentIndex ? 'w-4 h-3 bg-[#173C65]' : 'w-3 h-3 bg-[var(--gray)]'
                }`}
